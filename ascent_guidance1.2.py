...
current_mass = round(vessel.mass, 2)### I guess I should add comments###
# I am a new programmer, and this is my first program.
#it is intended to guide a Kerbal Space Program rocket into orbit
# track fuel and correct auto_pilot guidance
# seperating stages and payload fairings at currect times
